...
class _GeminiProviderFields(_StrictModel):
    enabled: bool = False
    base_url: str = ""
    api_key: str = ""
    chat_models: list[str] = Field(default_factory=list)
    image_models: list[str] = Field(default_factory=list)
    timeout_secs: int = Field(default=180, ge=5, le=600)


class GeminiProviderSettings(_GeminiProviderFields):
    has_api_key: bool = False


class GeminiProviderPatch(_GeminiProviderFields):
    pass
...
class _SettingsEditableFields(_StrictModel):
    ...
    gemini_provider: GeminiProviderPatch = Field(default_factory=GeminiProviderPatch)
...
class SettingsValues(_SettingsEditableFields):
    ...
    gemini_provider: GeminiProviderSettings = Field(default_factory=GeminiProviderSettings)
