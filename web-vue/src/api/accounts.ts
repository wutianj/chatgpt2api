...
export const accountsApi = {
  ...
  importCredentialPatches: async (
    ...
    return {
      ...
      accepted: Number(response.accepted || 0),
      invalid: Number(response.invalid || 0),
      missing_credentials: Number(response.missing_credentials || 0),
      missing_target: Number(response.missing_target || 0),
      ambiguous_target: Number(response.ambiguous_target || 0),
    }
  },
