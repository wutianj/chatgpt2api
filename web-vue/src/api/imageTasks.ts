...
export const HIGH_RES_IMAGE_SIZE_PRESETS: ImageSizePreset[] = [
  ...
  createSizePreset('1344x2016', '2:3', '2K'),
  createSizePreset('2016x1344', '3:2', '2K'),
  createSizePreset('1536x2048', '3:4', '2K'),
  createSizePreset('2048x1536', '4:3', '2K'),
  createSizePreset('1152x2048', '9:16', '2K'),
  createSizePreset('2048x1152', '16:9', '2K'),
