...
from api import accounts, admin_portal, ai, billing, canvas, gemini_accounts, image_tasks, prompts, system, tasks, user, user_auth
...
def create_app() -> FastAPI:
    ...
    app.include_router(gemini_accounts.create_router())
    app.include_router(image_tasks.create_router())
    app.include_router(prompts.create_router())
    app.include_router(system.create_router(app_version))
    app.include_router(user_auth.create_router())
    app.include_router(user.create_router())
    app.include_router(canvas.create_router())
    app.include_router(billing.create_router())
    app.include_router(tasks.create_router())
    app.include_router(admin_portal.create_router())

    @app.api_route("/pool", methods=["GET", "HEAD"], include_in_schema=False)
    @app.api_route("/pool/", methods=["GET", "HEAD"], include_in_schema=False)
    async def redirect_legacy_pool():
