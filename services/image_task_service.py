...
def _generation_handler(payload: dict[str, Any]):
...
def _edit_handler(payload: dict[str, Any]):
    if gemini_provider.is_gemini_model(payload.get("model")):
...
class ImageTaskService:
    def __init__(
        ...
        path: Path,
        *,
        generation_handler: Callable[[dict[str, Any]], dict[str, Any]] = _generation_handler,
        edit_handler: Callable[[dict[str, Any]], dict[str, Any]] = _edit_handler,
