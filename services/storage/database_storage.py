...
# Register user-domain models before shared metadata initialization.
from services.storage.user_repository import UserApiKeyModel, UserModel, UserSessionModel
