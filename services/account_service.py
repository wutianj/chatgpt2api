    ...
    def _request_access_token_refresh(
        ...
        *,
        ...
        stored_client_id = str(
            account.get("client_id") or account.get("oauth_client_id") or ""
        ).strip()
        source_type = self._normalize_source_type(account.get("source_type"))
        client_id = stored_client_id or (
            codex_oauth_client_id if source_type == "codex" else self._OAUTH_CLIENT_ID
        )
        refresh_data = {
        ...
        if client_id == codex_oauth_client_id:
            refresh_data["scope"] = codex_oauth_refresh_scope
        refresh_headers = {
