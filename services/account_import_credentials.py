...
_CREDENTIAL_ALIASES = {
    ...
    "client_id": ("client_id", "clientId", "oauth_client_id", "oauthClientId"),
    "auth_mode": ("auth_mode", "authMode"),
    "chatgpt_account_id": ("chatgpt_account_id", "chatgptAccountId"),
    "chatgpt_user_id": ("chatgpt_user_id", "chatgptUserId"),
...
def extract_import_credentials(raw: object) -> dict[str, str]:
    """Return token and OAuth identity fields from an import record.
